export default function MenuAmericano() {
    return (
        <div className="bg-gray-200 p-4 rounded-lg text-center group hover:bg-white hover:shadow-md hover:shadow-black/25 transition-all">
            <div className="text-center">
                <img src="/Image/coffee2.png" className="max-h-auto max-h-45 block mx-auto" alt="coffee" />
            </div>
            
            <h4 className="font-semibold my-2">Americano</h4>
